...
@NamedQuery(name = "Product.getProductById", query = "select new lk.ctech.cafe_management_system_backend.wrapper.ProductWrapper(p.id, p.name, p.description, p.price) from Product p where p.id=:id")
